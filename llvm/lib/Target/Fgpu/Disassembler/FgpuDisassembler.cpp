...
static DecodeStatus DecodeSimm10(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder);
static DecodeStatus DecodeUimm10(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder);

static DecodeStatus DecodeSimm7(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder);
...
static DecodeStatus DecodeVecRegsRegisterClass(MCInst &Inst,
                                               ...
                                               uint64_t Address,
                                               const void *Decoder) {
  Inst.addOperand(MCOperand::createReg(Fgpu::F0 + RegNo));
  return MCDisassembler::Success;
}
...
static DecodeStatus DecodeVecOffset9(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder) {
  Inst.addOperand(MCOperand::createImm(SignExtend32<16>(Insn>>7)));
  return MCDisassembler::Success;
}

static DecodeStatus DecodeSimm9(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder) {
  Inst.addOperand(MCOperand::createImm(SignExtend32<9>(Insn)));
  return MCDisassembler::Success;
}

static DecodeStatus DecodeUimm9(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder) {
  Inst.addOperand(MCOperand::createImm(Insn));
  return MCDisassembler::Success;
}

static DecodeStatus DecodeSimm10(MCInst &Inst, unsigned Insn, uint64_t Address, const void *Decoder) {
  Inst.addOperand(MCOperand::createImm(SignExtend32<10>(Insn)));
  return MCDisassembler::Success;
}
