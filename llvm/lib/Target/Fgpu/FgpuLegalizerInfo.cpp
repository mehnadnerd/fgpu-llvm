...
//===----------------------------------------------------------------------===//
/// \file
/// This file implements the targeting of the Machinelegalizer class for Fgpu.
...
FgpuLegalizerInfo::FgpuLegalizerInfo(const FgpuSubtarget &ST) {
  ...
  bool NoAlignRequirements = true; // TODO: check
...
bool FgpuLegalizerInfo::legalizeCustom(LegalizerHelper &Helper,
...
bool FgpuLegalizerInfo::legalizeIntrinsic(LegalizerHelper &Helper,
                                          MachineInstr &MI) const {
  MachineIRBuilder &MIRBuilder = Helper.MIRBuilder;
  const FgpuSubtarget &ST =
      static_cast<const FgpuSubtarget &>(MI.getMF()->getSubtarget());
  const FgpuInstrInfo &TII = *ST.getInstrInfo();
  const FgpuRegisterInfo &TRI = *ST.getRegisterInfo();
  const RegisterBankInfo &RBI = *ST.getRegBankInfo();

  return false; // TODO: I will make it legal
//
//  switch (MI.getIntrinsicID()) {
//  case Intrinsic::trap: {
//    MachineInstr *Trap = MIRBuilder.buildInstr(Fgpu::TRAP);
//    MI.eraseFromParent();
