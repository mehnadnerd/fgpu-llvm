...
//===----------------------------------------------------------------------===//
/// \file
/// This file declares the targeting of the RegisterBankInfo class for Fgpu.
/// \todo This should be generated by TableGen.
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_FGPU_FGPUREGISTERBANKINFO_H
#define LLVM_LIB_TARGET_FGPU_FGPUREGISTERBANKINFO_H
...
class FgpuGenRegisterBankInfo : public RegisterBankInfo {
#define GET_TARGET_REGBANK_CLASS
#include "FgpuGenRegisterBank.inc"
};

/// This class provides the information for the target register banks.
class FgpuRegisterBankInfo final : public FgpuGenRegisterBankInfo {
public:
  FgpuRegisterBankInfo(const TargetRegisterInfo &TRI);
