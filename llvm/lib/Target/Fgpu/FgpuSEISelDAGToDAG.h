...
#ifndef LLVM_LIB_TARGET_Fgpu_FgpuSEISELDAGTODAG_H
#define LLVM_LIB_TARGET_Fgpu_FgpuSEISELDAGTODAG_H
...
public:
  explicit FgpuSEDAGToDAGISel(FgpuTargetMachine &TM, CodeGenOpt::Level OL)
      : FgpuDAGToDAGISel(TM, OL) {}
