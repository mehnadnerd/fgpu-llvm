...
#ifndef LLVM_LIB_TARGET_FGPU_MCTARGETDESC_FGPUINSTPRINTER_H
#define LLVM_LIB_TARGET_FGPU_MCTARGETDESC_FGPUINSTPRINTER_H
#include "llvm/MC/MCInstPrinter.h"

namespace llvm {
// These enumeration declarations were originally in FgpuInstrInfo.h but
