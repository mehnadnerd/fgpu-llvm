//===---- FgpuCCState.h - CCState with Fgpu specific extensions -----------===//
//
...
class FgpuCCState : public CCState {
public:
  enum SpecialCallingConvType { Fgpu16RetHelperConv, NoSpecialCallingConv };
...
public:
  FgpuCCState(CallingConv::ID CC, bool isVarArg, MachineFunction &MF,
